...
const PageSettingsPanel = React.forwardRef<PageSettingsPanelHandle, PageSettingsPanelProps>(({
  ...
  const hasUnsavedChanges = useMemo(() => {
    ...
    return hasChanges;
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [name, slug, pageFolderId, isIndex, seoTitle, seoDescription, seoImage, seoNoindex, customCodeHead, customCodeBody, authEnabled, authPassword, collectionId, slugFieldId, nextPrevSortBy, nextPrevSortOrder, hideInNav, hideInFooter, navLabel, navOrder, dropdownMode, dropdownFolderId, dropdownCollectionId, dropdownTargetPageId, dropdownItemsMode, dropdownSelectedItemIds, stageForPublish, canHandleStatus, saveCounter]);
